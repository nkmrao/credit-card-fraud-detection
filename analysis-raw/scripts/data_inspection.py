...
# Concrete Strategy for Inspecting First Few Rows
# --------------------------------------------
# This strategy inspects the first few rows of the data.
class HeadInspectionStrategy(DataInspectionStrategy):
    def __init__(self, nrows: int = 10):
        self._nrows = nrows

    def inspect(self, df: pd.DataFrame):
        """
        Inspects and prints the first few rows the dataframe.

        Parameters:
        df (pd.DataFrame): The dataframe to be inspected.

        Returns:
        None: Prints the first few rows of the data.
        """
        print(df.head(self._nrows))
...
# Context Class for data inspection strategies
class DataInspector:
